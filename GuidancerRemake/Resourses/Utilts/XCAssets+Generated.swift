...
internal enum Asset {
  ...
  internal enum Icons {
    ...
    internal static let userCicrleLight = ImageAsset(name: "User_cicrle_light")
    internal static let vectorStroke = ImageAsset(name: "Vector (Stroke)")
  ...
  internal static let imagetest = ImageAsset(name: "imagetest")
  internal static let imagetest2 = ImageAsset(name: "imagetest2")
  internal static let `left` = ImageAsset(name: "left")
  internal static let mapImage = ImageAsset(name: "mapImage")
  internal static let mosow = ImageAsset(name: "mosow")
  ...
  internal static let weather = ImageAsset(name: "weather")
}
